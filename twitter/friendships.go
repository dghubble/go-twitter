...
// FriendOutgoingIncomingParams are paramenters for FriendshipService.Outgoing
type FriendOutgoingIncomingParams struct {
...
func (s *FriendshipService) Outgoing(params *FriendOutgoingIncomingParams) (*FriendIDs, *http.Response, error) {
	ids := new(FriendIDs)
	apiError := new(APIError)
...
func (s *FriendshipService) Incoming(params *FriendOutgoingIncomingParams) (*FriendIDs, *http.Response, error) {
	ids := new(FriendIDs)
	apiError := new(APIError)
